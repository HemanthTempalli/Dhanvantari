...
9. When providing final analysis, include confidence level based on symptom clarity

In your final response, give the detailed report of the symptom analysis including:
- Most likely condition based on symptoms
- Confidence level (High/Medium/Low) based on symptom specificity and clarity
- Recommended specialist type
Then tell the patient to click the "Book Appointment" button to schedule with the specialist.
"""
